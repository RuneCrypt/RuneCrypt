...
import net.runecrypt.fs.util.ByteBufferUtils;
import net.runecrypt.fs.util.crypto.Whirlpool;
...
public final class Cache implements Closeable {
	...
	public ChecksumTable createChecksumTable() throws IOException {
		...
		for (int i = 0; i < size; i++) {
			 ...
			 */
			if (buf.limit() > 0) { // some indices are not used, is this
									// appropriate?
