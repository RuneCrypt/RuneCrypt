...
*/
package net.runecrypt.codec.codec751.network;
 ...
 */
public class Codec751PipelineFactory implements ChannelPipelineFactory {
    ...
    public ChannelPipeline getPipeline() throws Exception {
        ...
        pipeline.addLast("upHandler", new UpstreamHandler(codec, codecManifest));
        return pipeline;
    }
}
